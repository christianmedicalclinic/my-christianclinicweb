...
// Remove "magkano ang", "how much is", "how much for", "price of", "magkano yung"
msg = msg
.replace(/magkano (ang|yung)\s+/i, '')
.replace(/how much (is|for)\s+/i, '')
...
// Exact match for general inquiries
